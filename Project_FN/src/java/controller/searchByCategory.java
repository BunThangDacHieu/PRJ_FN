 ...
 * @author DELL
 */
@WebServlet(name="searchByCategory", urlPatterns={"/search"})
public class searchByCategory extends HttpServlet {
    ...
    throws ServletException, IOException {
      String id_raw = request.getParameter("condition");
      int cid = Integer.parseInt(id_raw);
        DaoProduct daoP = new DaoProduct();
        List<Product> list = daoP.listProduct(cid);
        ...
        List<Product> listP = daoP.listByPage(list, start, end);
        request.setAttribute("listProduct", listP);
        request.setAttribute("page", page);
         request.setAttribute("num", num);
          request.setAttribute("id_raw", cid);
